...
PROJECT := RobotontNucleoMainboard
...
INCLUDE_PATHS += -I../mbed/TARGET_NUCLEO_L476RG/TOOLCHAIN_GCC_ARM
...
C_FLAGS += -DMBED_BUILD_TIMESTAMP=1505244491.5
...
CXX_FLAGS += -DMBED_BUILD_TIMESTAMP=1505244491.5
